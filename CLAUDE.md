...
driver — never commit that file, and in the game itself **`.`** draws the hitboxes the sim tests
and, on a second press, the routes every walker is following. How to use all four:
