...
(function () {
  ...
  // 16 sway frames of one snowy pine, 20x27, area-downscaled from the 27x37
  // originals in docs/media/new_media and snapped back onto TSPAL (tools:
  // the scratch shrink.js). The full-size art walled the treeline in - 27 px
  // of canopy on a 16 px tile grid is a 69% overlap - so the sprite came down
  // to 20x27, which reads as a forest of trees rather than one green mass and
  // costs 46% of the fill. Source file order is not the animation order: the
  // files are variants, so they are laid out here as a CYCLE
  // (1 2 16 3 15 6 5 13 14 9 10 11 4 12 7 8) sorted so consecutive frames
  // differ least - which also sorted the baked-in vertical bob into one
  ...
  const treeSway = [
    ...
    [ // 3 (003.png)
      ...
      '..kmGhgmGggggghGmk..',
      '.gswsLmmLLghLLhlssg.',
      'kmmlLmwwssGmslgllmsd',
      'oghgmslSsSlLlsGmgGho',
      '..olmghmLmLhGldLloo.',
      '..okkodLdGUkdgokho..',
      '.......oUUuUo.......',
      '.......oUuuUo.......',
    ...
    [ // 7 (013.png)
      ...
      '..LslhhmGggghhhlSm..',
      '.gswslwmlshlmlgLmmh.',
      'oLmlLsSSSSllmmhmhLsg',
      'okdgmmlslsLhLmglGkko',
      '..oLlddLdLgddgodlo..',
      '..okd.kkUUUUo.......',
      '.......oUUuUo.......',
      '.......oUuuUo.......',
    ...
    [ // 12 (004.png)
      ...
      '..kmGhgmGggggghGmk..',
      '.kswsLlLGLghLLhlssg.',
      'klSlLmwsmsGmslgllmmd',
      'kGLgmslSsSlLlsGmgGGk',
      '.oolmgGmLmLhhldLloo.',
      '..okkodLdGUkdgokho..',
      '.......oUUuUo.......',
      '.......oUuuUo.......',
  ...
  window.SPRITES = {
    ...
    treeAtlas: (() => {
      ...
      const c = document.createElement('canvas');
      c.width = fw * treeSpr.length; c.height = fh;
      const g = c.getContext('2d');
      g.imageSmoothingEnabled = false;
      treeSpr.forEach((f, i) => g.drawImage(f, i * fw, 0));
      c.fw = fw; c.fh = fh;
      return c;
    })(),
