...
const PATCH_TXT = 'PATCH 2.04'; // printed bottom-right of the title screen; click it for the notes
// one sentence per patch, newest first - the biggest change only, in plain english
const PATCH_NOTES = [
  ['2.04', 'THE PINES ARE SMALLER, SO A TREELINE READS AS TREES INSTEAD OF ONE GREEN WALL; SUN SHAFTS ARE A MOMENT NOW RATHER THAN THE WEATHER - THE WHOLE EAGLE RIDE AND A BEAT AFTER LANDING, AND A QUARTER MINUTE AROUND NOON; SNOW FALLS IN BIGGER, SPARSER FLAKES THE CLOSER THE CAMERA IS; AND THE FRAME RATE IS ROUGHLY DOUBLE, BECAUSE EVERY PINE, MOTE, STAR AND FLAKE NOW DRAWS OUT OF A SINGLE BAKED TEXTURE.'],
