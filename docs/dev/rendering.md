...
storing anything per tree. The tree under the hero's cursor holds full ink so the one being
worked stays crisp, and a mid-shake chop lifts a faded neighbour back to opaque. While any pine
