...
| the one arrow body every shaft draws (flying, volley rain): the DDA rasteriser (crisp diagonals, mirrored vanes) and its rim/colour painter | `arrowBodyPx`, `paintArrowPx` (the master: `ARROW_MAP`/`ARROW_BODY`, actions.js) | `entity draw` |
